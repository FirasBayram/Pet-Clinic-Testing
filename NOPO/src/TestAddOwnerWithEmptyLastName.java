...
public class TestAddOwnerWithEmptyLastName {
	//Driver definition
	...
	String fnString = "Totti";
	lastName.sendKeys(fnString);
	...
	String  ActualString = driver.findElement(By.xpath("//*[@id=\"add-owner-form\"]/div[1]/div[2]/div/span[2]")).getText();

...
public class TestAddOwnerWithLongTelephone {
	//Driver definition
	...
	//fill the text input of telephone with an invalid value 
	WebElement telephone = driver.findElement(By.id("telephone"));
	String tString = "1234567898765";
	...
	//Assert that the message 'numeric value out of bounds (<10 digits>.<0 digits> expected)' is displayed
